...
void Screen_Config(void)
{
      ...
      SM_WriteData(TCXXX_ADDRESS,0x02AC,0x000090BD,4); // MIPI_PLL_CNF
      SmDelayms(1);
      ...
      SM_WriteData(TCXXX_ADDRESS,0x0150,0x00000160,4); // FUNC_MODE
      ...
      SM_WriteData(TCXXX_ADDRESS,0x0170,0x00000677,4); // APF_VDELAYCNT 1080:0x00000677
      SM_WriteData(TCXXX_ADDRESS,0x017C,0x00000081,4); // DSI_TX_MODE
      SM_WriteData(TCXXX_ADDRESS,0x018C,0x00000001,4); // DSI_HSYNC_WIDTH
      SM_WriteData(TCXXX_ADDRESS,0x0190,0x00000104,4); // DSI_HBPR
      ...
      SM_WriteData(TCXXX_ADDRESS,0x0254,0x00000006,4); // LPTXTIMECNT
      SM_WriteData(TCXXX_ADDRESS,0x0258,0x00240204,4); // TCLK_HEADERCNT
      SM_WriteData(TCXXX_ADDRESS,0x025C,0x000D0008,4); // TCLK_TRAILCNT
      SM_WriteData(TCXXX_ADDRESS,0x0260,0x00140006,4); // THS_HEADERCNT
      SM_WriteData(TCXXX_ADDRESS,0x0264,0x00004268,4); // TWAKEUPCNT
      SM_WriteData(TCXXX_ADDRESS,0x0268,0x0000000F,4); // TCLK_POSTCNT
      ...
      SM_WriteData(TCXXX_ADDRESS,0x0278,0x00060005,4); // BTA_COUNT
      ...
      SM_WriteData(TCXXX_ADDRESS,0x04AC,0x000090BD,4); // MIPI_PLL_CNF
      SmDelayms(1);
      ...
      SM_WriteData(TCXXX_ADDRESS,0x0350,0x00000160,4); // FUNC_MODE
      ...
      SM_WriteData(TCXXX_ADDRESS,0x0370,0x00000677,4); // APF_VDELAYCNT  0x00000677:1080 0x000002BC
      SM_WriteData(TCXXX_ADDRESS,0x037C,0x00000081,4); // DSI_TX_MODE
      SM_WriteData(TCXXX_ADDRESS,0x038C,0x00000001,4); // DSI_HSYNC_WIDTH
      SM_WriteData(TCXXX_ADDRESS,0x0390,0x00000104,4); // DSI_HBPR
      ...
      SM_WriteData(TCXXX_ADDRESS,0x0454,0x00000006,4); // LPTXTIMECNT
      SM_WriteData(TCXXX_ADDRESS,0x0458,0x00240204,4); // TCLK_HEADERCNT
      SM_WriteData(TCXXX_ADDRESS,0x045C,0x000D0008,4); // TCLK_TRAILCNT
      SM_WriteData(TCXXX_ADDRESS,0x0460,0x00140006,4); // THS_HEADERCNT
      SM_WriteData(TCXXX_ADDRESS,0x0464,0x00004268,4); // TWAKEUPCNT
      SM_WriteData(TCXXX_ADDRESS,0x0468,0x0000000F,4); // TCLK_POSTCNT
      ...
      SM_WriteData(TCXXX_ADDRESS,0x0478,0x00060005,4); // BTA_COUNT
     ...
     //Data Compression Method Selection       
      ...
      //Interface Set
      SM_WriteData(TCXXX_ADDRESS, 0x0504,0x0015,2);
      SM_WriteData(TCXXX_ADDRESS, 0x0504,0x10B4,2);//0x01B4 0x10B4
      SmDelayms(1);
      //CMD3 Select Enable
      SM_WriteData(TCXXX_ADDRESS, 0x0504,0x8039,2);
      ...
      SM_WriteData(TCXXX_ADDRESS, 0x0504,0x0008,2); 
       SmDelayms(1);
      //Display Mode Select(YYG Rainbow RGB)
      SM_WriteData(TCXXX_ADDRESS, 0x0504,0x0015,2);
      SM_WriteData(TCXXX_ADDRESS, 0x0504,0x01C9,2);
       SmDelayms(1);
     //Data Compression Method Selection 
      ...
      SM_WriteData(TCXXX_ADDRESS,0x500C,0x84E0,2); // STX0_FPX
      ...
      SM_WriteData(TCXXX_ADDRESS,0x8420,0x06,1); // EQ_BYPS
      ...
      SM_WriteData(TCXXX_ADDRESS,0x8C08,0x52,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C09,0x62,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C0A,0x88,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C0B,0x88,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C0C,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C0D,0x88,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C0E,0x88,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C0F,0x88,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C10,0x1C,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C11,0x15,1); // EDID_RAM
      ...
      SM_WriteData(TCXXX_ADDRESS,0x8C36,0x02,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C37,0x3A,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C38,0x80,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C39,0x18,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C3A,0x71,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C3B,0x38,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C3C,0x2D,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C3D,0x40,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C3E,0x58,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C3F,0x2C,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C40,0x45,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C41,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C42,0xC4,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C43,0x8E,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C44,0x21,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C45,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C46,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C47,0x1E,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C48,0x02,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C49,0x3A,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C4A,0x80,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C4B,0x18,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C4C,0x71,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C4D,0x38,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C4E,0x2D,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C4F,0x40,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C50,0x58,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C51,0x2C,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C52,0x45,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C53,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C54,0xC4,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C55,0x8E,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C56,0x21,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C57,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C58,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C59,0x1E,1); // EDID_RAM
      ...
      SM_WriteData(TCXXX_ADDRESS,0x8C5F,0x54,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C60,0x6F,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C61,0x73,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C62,0x68,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C63,0x69,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C64,0x62,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C65,0x61,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C66,0x2D,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C67,0x55,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C68,0x48,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C69,0x32,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C6A,0x44,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C6B,0x0A,1); // EDID_RAM
      ...
      SM_WriteData(TCXXX_ADDRESS,0x8C7F,0xE1,1); // EDID_RAM
      ...
      SM_WriteData(TCXXX_ADDRESS,0x8C85,0x90,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C86,0x10,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C87,0x10,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C88,0x01,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C89,0x10,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C8A,0x01,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C8B,0x10,1); // EDID_RAM
      ...
      SM_WriteData(TCXXX_ADDRESS,0x8C9A,0x02,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C9B,0x3A,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C9C,0x80,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C9D,0x18,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C9E,0x71,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8C9F,0x38,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CA0,0x2D,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CA1,0x40,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CA2,0x58,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CA3,0x2C,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CA4,0x45,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CA5,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CA6,0xC4,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CA7,0x8E,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CA8,0x21,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CA9,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CAA,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CAB,0x1E,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CAC,0xD8,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CAD,0x09,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CAE,0x80,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CAF,0xA0,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CB0,0x20,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CB1,0xE0,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CB2,0x2D,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CB3,0x10,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CB4,0x10,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CB5,0x60,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CB6,0xA2,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CB7,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CB8,0xC4,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CB9,0x8E,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CBA,0x21,1); // EDID_RAM
      ...
      SM_WriteData(TCXXX_ADDRESS,0x8CBE,0x02,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CBF,0x3A,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CC0,0x80,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CC1,0x18,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CC2,0x71,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CC3,0x38,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CC4,0x2D,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CC5,0x40,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CC6,0x58,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CC7,0x2C,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CC8,0x45,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CC9,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CCA,0xC4,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CCB,0x8E,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CCC,0x21,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CCD,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CCE,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CCF,0x1E,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CD0,0xD8,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CD1,0x09,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CD2,0x80,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CD3,0xA0,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CD4,0x20,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CD5,0xE0,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CD6,0x2D,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CD7,0x10,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CD8,0x10,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CD9,0x60,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CDA,0xA2,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CDB,0x00,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CDC,0xC4,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CDD,0x8E,1); // EDID_RAM
      SM_WriteData(TCXXX_ADDRESS,0x8CDE,0x21,1); // EDID_RAM
      ...
      SM_WriteData(TCXXX_ADDRESS,0x8CFF,0xDD,1); // EDID_RAM
      // HDCP Setting
