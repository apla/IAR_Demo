       ...
       //     SM_WriteData(TCXXX_ADDRESS, 0x0504,0x10C9,2);        
        ...
        //    SM_WriteData(TCXXX_ADDRESS, 0x0504,0x0190,2);
           ...
           // SM_WriteData(TCXXX_ADDRESS, 0x0504,0x0035,2);//add 
            ...
            SM_WriteData(TCXXX_ADDRESS,0x8C36,0x90,1); // EDID_RAM
            ...
            SM_WriteData(TCXXX_ADDRESS,0x8C47,0x18,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C48,0x90,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C49,0x65,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C4A,0xA0,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C4B,0xED,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C4C,0x50,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C4D,0x00,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C4E,0x18,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C4F,0xA0,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C50,0x75,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C51,0x28,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C52,0x88,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C53,0x00,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C54,0xA0,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C55,0x00,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C56,0x5A,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C57,0x00,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C58,0x00,1); // EDID_RAM
            SM_WriteData(TCXXX_ADDRESS,0x8C59,0x18,1); // EDID_RAM
            ...
            SM_WriteData(TCXXX_ADDRESS,0x8C7F,0xE7,1); // EDID_RAM
